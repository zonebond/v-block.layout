...
// utils
import {pixels, assignment, classnames, HackStyleSheet} from './common'
...
Group.propTypes = {
  ...
  horizontal: PropTypes.oneOf(main_axis),
  vertical: PropTypes.oneOf(cross_axis),
...
export class VGroup extends Component {
  ...
  render() {
    ...
    const {horizontalAlign, verticalAlign, horizontal, vertical, ...other} = props;
...
VGroup.propTypes = {
  ...
  horizontal: PropTypes.oneOf(cross_axis),
  vertical: PropTypes.oneOf(main_axis),
};
